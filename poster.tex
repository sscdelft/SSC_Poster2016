...
{Chapter activities}
  ...
  \begin{itemize}
    ...
    \item \emph{Company visits} and \emph{socials events} like faculty BBQ, movie-night, \dots
   \end{itemize}
...
\begin{textbox}(about) at ($(contents map.south east)+(0cm,-3cm)$) [below left] <25.4cm>
{Who are we?}

  The Chapter at TU Delft has been founded in 2014.

  \begin{itemize}
    \item \emph{President:} J\"orn Zimmerling
    \item \emph{Vice President:} Lisa Wobbes
    \item \emph{Secretary:} Zaza van der Have
    \item \emph{Treasurer:} Menel Rahrah
    \item \emph{Webmaster:} Baljinnyam Sereeter
    \item \emph{BaNaNa off.:} Manuel Baumann
    \item \emph{Social-event off.:} Mohamed el Abbassi
  \end{itemize}
